...
public final class AVariablePrimaryExpression extends PPrimaryExpression
{
    ...
    public Object clone()
    {
        return new AVariablePrimaryExpression(
    ...
    {
        ((Analysis) sw).caseAVariablePrimaryExpression(this);
    }
