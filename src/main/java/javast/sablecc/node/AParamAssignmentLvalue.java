...
public final class AParamAssignmentLvalue extends PParamAssignmentLvalue
{
    private TIdentifier _identifier_;
    private TColonEq _colonEq_;

    public AParamAssignmentLvalue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParamAssignmentLvalue(
    ...
    {
        ((Analysis) sw).caseAParamAssignmentLvalue(this);
    }
