...
public final class AUnaryPowerExpression extends PPowerExpression
{
    private PUnaryExpression _unaryExpression_;

    public AUnaryPowerExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnaryPowerExpression(
    ...
    {
        ((Analysis) sw).caseAUnaryPowerExpression(this);
    }
