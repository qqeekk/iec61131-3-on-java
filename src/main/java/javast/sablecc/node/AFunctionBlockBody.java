...
public final class AFunctionBlockBody extends PFunctionBlockBody
{
    private PStatementList _statementList_;

    public AFunctionBlockBody()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAFunctionBlockBody(this);
    }
