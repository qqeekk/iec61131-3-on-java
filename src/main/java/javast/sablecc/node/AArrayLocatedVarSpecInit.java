...
public final class AArrayLocatedVarSpecInit extends PLocatedVarSpecInit
{
    private PArraySpecInit _arraySpecInit_;

    public AArrayLocatedVarSpecInit()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArrayLocatedVarSpecInit(
    ...
    {
        ((Analysis) sw).caseAArrayLocatedVarSpecInit(this);
    }
