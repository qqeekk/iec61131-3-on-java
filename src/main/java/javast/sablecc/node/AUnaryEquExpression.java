...
public final class AUnaryEquExpression extends PEquExpression
{
    private PAddExpression _addExpression_;

    public AUnaryEquExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnaryEquExpression(
    ...
    {
        ((Analysis) sw).caseAUnaryEquExpression(this);
    }
