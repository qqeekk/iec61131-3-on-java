...
public final class AInitializedStructureSpecification extends PStructureSpecification
{
    private PInitializedStructure _initializedStructure_;

    public AInitializedStructureSpecification()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInitializedStructureSpecification(
    ...
    {
        ((Analysis) sw).caseAInitializedStructureSpecification(this);
    }
