...
public final class AOtherFunctionBlockVarDeclarations extends PFunctionBlockVarDeclarations
{
    private POtherVarDeclarations _otherVarDeclarations_;

    public AOtherFunctionBlockVarDeclarations()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOtherFunctionBlockVarDeclarations(
    ...
    {
        ((Analysis) sw).caseAOtherFunctionBlockVarDeclarations(this);
    }
