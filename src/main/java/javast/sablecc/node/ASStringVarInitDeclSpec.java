...
public final class ASStringVarInitDeclSpec extends PVarInitDeclSpec
{
    private PSingleByteStringSpec _singleByteStringSpec_;

    public ASStringVarInitDeclSpec()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASStringVarInitDeclSpec(
    ...
    {
        ((Analysis) sw).caseASStringVarInitDeclSpec(this);
    }
