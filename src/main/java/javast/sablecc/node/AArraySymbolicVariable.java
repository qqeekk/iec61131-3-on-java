...
public final class AArraySymbolicVariable extends PSymbolicVariable
{
    private PSymbolicVariable _symbolicVariable_;
    private PSubscriptList _subscriptList_;

    public AArraySymbolicVariable()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArraySymbolicVariable(
    ...
    {
        ((Analysis) sw).caseAArraySymbolicVariable(this);
    }
