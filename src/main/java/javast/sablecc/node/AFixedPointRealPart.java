...
public final class AFixedPointRealPart extends PFixedPointRealPart
{
    private TDot _dot_;
    private TInteger _integer_;

    public AFixedPointRealPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFixedPointRealPart(
    ...
    {
        ((Analysis) sw).caseAFixedPointRealPart(this);
    }
