...
public final class AElementarySimpleSpecification extends PSimpleSpecification
{
    private PElementaryTypeName _elementaryTypeName_;

    public AElementarySimpleSpecification()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AElementarySimpleSpecification(
    ...
    {
        ((Analysis) sw).caseAElementarySimpleSpecification(this);
    }
