...
public final class AConstantPrimaryExpression extends PPrimaryExpression
{
    private PConstant _constant_;

    public AConstantPrimaryExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConstantPrimaryExpression(
    ...
    {
        ((Analysis) sw).caseAConstantPrimaryExpression(this);
    }
