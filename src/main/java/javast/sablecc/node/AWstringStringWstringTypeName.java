...
public final class AWstringStringWstringTypeName extends PStringWstringTypeName
{
    private TWstringTypeName _wstringTypeName_;

    public AWstringStringWstringTypeName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AWstringStringWstringTypeName(
    ...
    {
        ((Analysis) sw).caseAWstringStringWstringTypeName(this);
    }
