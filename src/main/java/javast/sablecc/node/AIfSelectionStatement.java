...
public final class AIfSelectionStatement extends PSelectionStatement
{
    private PIfStatement _ifStatement_;

    public AIfSelectionStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfSelectionStatement(
    ...
    {
        ((Analysis) sw).caseAIfSelectionStatement(this);
    }
