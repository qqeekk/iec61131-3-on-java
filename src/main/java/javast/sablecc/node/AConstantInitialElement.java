...
public final class AConstantInitialElement extends PInitialElement
{
    private PConstant _constant_;

    public AConstantInitialElement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConstantInitialElement(
    ...
    {
        ((Analysis) sw).caseAConstantInitialElement(this);
    }
